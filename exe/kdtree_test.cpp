...
int main(int argc, char** argv){
    ...
    cout << "Number of correspondences found between first two measurements: " << img_corr.size() << endl;
    cout << "Indices of corresponding points in their own vectors: " << endl;
    ...
    cout << "Number of correspondences found between world and first measurement: " << wrld_corr.size() << endl;
    cout << "Indices of corresponding points in their own vectors: " << endl;
